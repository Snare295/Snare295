...
| 🟩 Imperative programming      | 🟩 new                | 🟩 Mutable state     | 🟩 BLoC                  |
...
| General               | Internals                | Widget specific          | App specific         | Packages              |
|-----------------------|--------------------------|--------------------------|----------------------|-----------------------|
| 🟩 flutter cli       | 🟩 State (UI)            | 🟩 Stateless widget      | 🟩 Async launch     | 🟩 shared_preferences|
| 🟩 pub               | 🟩 Key                   | 🟩 Statefull widget      | 🟩 Pages            | 🟩 dynamic_color     |
| 🟩 Internal linter   | 🟩 context, context tree | 🟩 Widget build          | 🟩 Assets inclusion | 🟩 url_launcher      |
| 🟩 Github CI builds  | 🟩 Class is Object       | 🟩 Navigator             | 🟩 API based        |                      |
| 🟩 Null safety       | 🟩 \_var/func is private | 🟩 ListView              |                      |                      |
| 🟩 DevTools          | 🟩 Named constructor     | 🟩 Infinite width/height |                      |                      |
| 🟩 Strict naming     | 🟩 Optional consturctor  | 🟩 SearchDelegate        |                      |                      |
| 🟩 Mixed binding     | ⬜ isolate               | ⬜ Animations            |                      |                      |
| 🟩 Hot reload        | 🟩 const UI elements     |                          |                      |                       |
|                       | 🟩 Sturcture type binding|                          |                      |                      |
|                       | 🟩 @override             |                          |                      |                      |
|                       | 🟩 UI render             |                          |                      |                      |
